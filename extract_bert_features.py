...
print("\n🤖 Extracting BERT embeddings from captions...")
...
print("=" * 80)
print("\n✅ Extracted 768-dimensional IndoBERT embeddings")
print(f"✅ Saved {len(bert_features_df)} embeddings to {output_path}")
