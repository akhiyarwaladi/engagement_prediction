...
print("\n🖼️ Extracting ViT embeddings from images...")
...
if len(non_zero_embeddings) > 0:
    ...
    if mean_norm < 5:
        print("   ⚠️  Warning: Embedding norms unusually low")
    elif mean_norm > 30:
        print("   ⚠️  Warning: Embedding norms unusually high")
    else:
    ...
    if std_per_dim < 0.2:
        print("   ⚠️  Warning: Low variability, embeddings may be too similar")
    else:
        print("   ✅ Good variability across embeddings!")
else:
    print("   ⚠️  No valid image embeddings found")
...
print(f"\n✅ Extracted 768-dimensional ViT embeddings")
print(f"✅ Saved {len(vit_features_df)} embeddings to {output_path}")
...
print("   3. Target achievement likely! ✅")
